...
public class Simulatore {
	//Modello -> Quale è lo stato del sistema ad ogni passo?
	private Graph<Country, DefaultEdge> grafo;
	
	//Tipi di evento -> coda prioritaria
	private PriorityQueue<Evento> queue; //la coda serve se la generazione di eventi è durante la simulazione
